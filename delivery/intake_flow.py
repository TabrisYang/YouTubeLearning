...
{"topic": "收斂後的主題描述（比使用者原話更精確）",
 "include": ["必須涵蓋的子主題", ...],
 "exclude": ["明確排除的子主題", ...],
 "search_seeds": ["訪談與主題中出現的具體實體，用創作者下標題的說法——
   產品/品牌/工具/指標名（例：GPT-5、Claude、n8n、布林通道、MACD），3-8 個", ...],
...
6. 工具/軟體類主題：recency_months 給 12-24（版本會過時）；新聞時事類 0.1-1；理論/通識類給 null
7. search_seeds 是搜尋命中的關鍵：收斂後的主題是書面語，但影片標題用的是
   產品名與口語（「GPT-5 實測」而非「大型語言模型技術進展」）——
   把訪談中出現的具體實體都收進去
